  ...
  return (
    <div className='z-20 h-full  w-full'>
      <div className='w-full absolute top-5 px-14 flex justify-between max-[600px]:justify-center  min-[1600px]:px-[290px] xl:px-[160px]  max-[600px]:flex-col  items-center'>
        <h1 className='text-[35px] z-20 text-white font-semibold  text-center min-[1330px]:text-[45px] xl:text-[35px] xl:font-semibold  max-[600px]:text-[30px] max-[410px]:text-[20px]  max-[600px]:font-semibold '>Asad {''}<span className='text-[25px] text-[#d3352f]'> Ali</span> </h1>
